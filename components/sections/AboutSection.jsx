...
const AboutBackground = dynamic(() => import('@/components/three/AboutBackground'), { ssr: false })
...
export default function AboutSection() {
  ...
  return (
    <section ref={sectionRef} className={styles.section}>
      ...
      {/* 3D animated background (behind the grid content) */}
      <div className={styles.aboutBg} aria-hidden>
        <AboutBackground />
      </div>
